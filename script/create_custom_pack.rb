...
excel_file       = 'data/aerodromos-y-helipuertos-pub-210426.xlsx'
...
custom_pack_zip  = 'FEMPPA-Mexican-Airports-v2.3.zip'
...
surface_type_map = {
  ...
  "PAVIMENTO Y TERRACERIA" => "Pavement and Dirt",
  "TERRENO NATURAL CON PASTO" => "Natural Terrain with Grass",
  "TERRENO NATURAL DE ARCILLA COMPACTADA" => "Natural Compacted Clay Terrain",
  "TUCURUGUAY COMPACTADO" => "Compacted Tucuruguay",
  "ASFALTO Y TERRACERIA" => "Asphalt and Dirt",
  "ASFALTO Y PASTO" => "Asphalt and Grass",
  "ASFALTO Y CONCRETO HIDRAULICO" => "Asphalt and Hydraulic Concrete",
  "ASFALTO Y TUCURUGUAY COMPACTADO" => "Asphalt and Compacted Tucuruguay",
  "ASFALTO / TERRACERIA" => "Asphalt and Dirt",
  "ASFALTO-TERRACERIA" => "Asphalt and Dirt",
  "ASFALTO COMPACTO Y TERRACERIA" => "Compact Asphalt and Dirt",
  "TERRACERIA  Y ASFALTO" => "Dirt and Asphalt",
  "TERRACERÍA Y PASTO" => "Dirt and Grass",
  "CEMENTO / PASTO" => "Cement and Grass",
  "CONCRETO Y TUCURUGUAY COMPACTADO" => "Concrete and Compacted Tucuruguay",
  "MIXTA ASFALTO Y TERRACERIA" => "Mixed: Asphalt and Dirt",
  "MIXTA: ASFALTO / TERRACERÍA" => "Mixed: Asphalt and Dirt",
  "MIXTA CONCRETO" => "Mixed Concrete",
  "MIXTA CONCRETO HIDRAHULICO-TERRACERIA" => "Mixed: Hydraulic Concrete and Dirt",
  "MIXTA CONCRETO Y TERRENO NATURAL" => "Mixed: Concrete and Natural Terrain",
  "MIXTA 1175 M CONCRETO, 200 M TERRACERIA" => "Mixed: Concrete 1175m / Dirt 200m",
  "MIXTO CONCRETO HIDRÁHULICO / ASFALTO" => "Mixed: Hydraulic Concrete and Asphalt"
}
...
def generate_kml_for_layer(excel_file, kml_file, kmz_file, layer_type, layer_name, maps)
  ...
  File.open(kml_file, "w") do |file|
    ...
    xml.kml(xmlns: "http://www.opengis.net/kml/2.2") do
      ...
      # 29: ¿VIGENTE?                → Active?
      # 30: SITUACIÓN                 → Status
      # 31: AEROPUERTO DE CORDINACIÓN → Coordination Airport
      #
      # Note: AERONAVE CRITICA absent again in April 2026 (was restored in March 2026, now removed)
      ...
      (1..sheet.last_row).each do |i|
        ...
        critical_aircraft = ""           # AERONAVE CRITICA removed in April 2026
        issue_date        = row[24].to_s.strip
        permit_duration   = row[25].to_s.strip
        expiration_date   = row[26].to_s.strip
        month             = row[27].to_s.strip
        year              = row[28].to_s.strip
        active            = row[29].to_s.strip
        status            = row[30].to_s.strip
        coordination_apt  = row[31].to_s.strip
...
FileUtils.cp(kmz_file_apts, File.join(navdata_dir, "FEMPPA Apts 04-26.kmz"))
FileUtils.cp(kmz_file_heli, File.join(navdata_dir, "FEMPPA Heli 04-26.kmz"))
